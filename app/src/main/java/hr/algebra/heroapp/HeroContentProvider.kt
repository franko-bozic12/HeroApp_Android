...
import hr.algebra.heroapp.dao.Repository
import hr.algebra.heroapp.factory.getHeroRepository
import hr.algebra.heroapp.model.Item

private const val AUTHORITY = "hr.algebra.heroapp.api.provider"
...
class HeroContentProvider : ContentProvider() {
    ...
    override fun onCreate(): Boolean {
        repository = getHeroRepository(context)
        return true
    }
